...
public final class RVP_FireSupportWeaponBudget {
    /** 单个顶层弹体允许的最大生命期，单位 Tick。 */ public static final int MAX_LIFE_TICKS = 2400;
    /** 单个顶层弹体允许直接展开的最大子实体数。 */ public static final int MAX_DIRECT_CHILDREN = 256;
    /** 单任务顶层弹体与直接子实体合计上限。 */ public static final int MAX_EXPANDED_ENTITIES_PER_MISSION = Integer.MAX_VALUE;
    /** 可由炮火 profile 引用的主爆炸最大半径，单位格。 */ public static final float MAX_EXPLOSION_RADIUS = 64.0F;
    /** 可由炮火 profile 引用的主爆炸最大伤害。 */ public static final float MAX_EXPLOSION_DAMAGE = 100_000.0F;

    private RVP_FireSupportWeaponBudget() {}

    /**
     * 校验单发武器和 profile 顶层弹数共同形成的最坏实体预算。
     * 多级子母弹因无法在一个不可变索引描述中证明全链上界，首版明确拒绝。
     */
