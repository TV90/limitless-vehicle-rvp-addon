...
public final class RvpRocketCcipOverlay {
    private static final Logger LOGGER = LogUtils.getLogger();

    private static final ResourceLocation FALLBACK_TEXTURE =
            ResourceLocation.fromNamespaceAndPath("rvp", "textures/ui/ccip.png");
    private static final ResourceLocation REGISTERED_TEXTURE = YwzjRvp.modLocation("dynamic/ccip");
    ...
    public static Vec3 getCurrentScreenHitPos() {
        ...
        Vec3 rawHit = RvpRocketBallistics.computeWeaponImpact(
        ...
        Vec3 hitPos = RvpRocketCcipState.smooth(
