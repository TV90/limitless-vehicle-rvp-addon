...
| [RVP Distant Horizons 地形 LOD 遮挡兼容技术文档与调参指南](./RVP超视距载具渲染/RVP_DistantHorizons地形LOD遮挡兼容技术文档与调参指南_20260829.md) | 客户端渲染 / 整合包 / QA | DH API 7.0.1+ 深度合成、显式回退、配置语义、bias 校准、诊断与实机验证矩阵 |
